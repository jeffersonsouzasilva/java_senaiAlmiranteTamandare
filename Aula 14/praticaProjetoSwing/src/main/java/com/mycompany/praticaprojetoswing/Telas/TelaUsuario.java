...
public class TelaUsuario extends javax.swing.JInternalFrame {
    ...
    /**
     * O código abaixo é um construto, é usado para inicializar o Módulo de
     * Conexão
     */
    public TelaUsuario() {
        initComponents();
    ...
    private void adicionar() {
        ...
        try {
            ...
            if ((txtUsuId.getText().isEmpty()) || (txtUsuNome.getText().isEmpty())
                ...
                if (adicionado > 0) {
                    JOptionPane.showMessageDialog(null, "Usuário adiocionado com sucesso !");
    ...
    private void alterar() {
        ...
        try {
            ...
            if ((txtUsuId.getText().isEmpty()) || (txtUsuNome.getText().isEmpty())
                ...
                int adicionado = pst.executeUpdate();
                if (adicionado > 0) {
                    JOptionPane.showMessageDialog(null, "Dados o usuário alterados com sucesso !");
                    txtUsuId.setText(null);
                    txtUsuNome.setText(null);
                    txtUsuFone.setText(null);
                    txtUsuLogin.setText(null);
