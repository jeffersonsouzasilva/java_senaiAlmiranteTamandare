...
/*
3.Criar a Classe Principal (Main)
  Na classe principal, vamos instanciar objetos das subclasses e demonstrar o polimorfismo.
 */
...
public class Main {
    public static void main(String[] args) {
        ...
        // Definindo os nomes usando o método set
        cachorro.setNome("Rex");
        gato.setNome("Mimi");

        // Usando o método fazerSom() (polimorfismo)
        cachorro.fazerSom(); // Saída: Rex diz: Au Au!
        gato.fazerSom();     // Saída: Mimi diz: Miau!

        // Exibindo os nomes usando o método get
        System.out.println("Nome do cachorro: " + cachorro.getNome()); // Saída: Nome do cachorro: Rex
        System.out.println("Nome do gato: " + gato.getNome());         // Saída: Nome do gato: Mimi
    }
}
